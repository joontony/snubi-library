...
public class AESUtil {
	...
	private String cbiv;
    private SecretKey cbkey;
    
    public AESUtil(String strKey) throws UnsupportedEncodingException {
        cbiv = strKey.substring(0, 16);
    ...
    public void encryptFile(File inputFile, File outputFile) throws IOException, NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException,UnsupportedEncodingException {
            Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
            cipher.init(Cipher.ENCRYPT_MODE, this.cbkey, new IvParameterSpec(this.cbiv.getBytes("UTF-8")));
        ...
        public void decryptFile(File encryptedFile, File decryptedFile) throws IOException, NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException,
            BadPaddingException, IllegalBlockSizeException {
            Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
            cipher.init(Cipher.DECRYPT_MODE, this.cbkey, new IvParameterSpec(this.cbiv.getBytes("UTF-8")));
